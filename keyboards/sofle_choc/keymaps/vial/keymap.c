...
#ifdef OLED_ENABLE
// Bitmaps (32x8 pixels, 1 page each)
...
static const char PROGMEM img_lyr_base[] = {
...
static const char PROGMEM img_lyr_lower[] = {
    0xFF, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81,
    0x9F, 0x9F, 0x9F, 0x9F, 0x9F, 0x9F, 0x9F, 0x9F, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0xFF
};
...
static const char PROGMEM img_lyr_adjust[] = {
    0xFF, 0x81, 0x81, 0x9F, 0x9F, 0x9F, 0x9F, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81,
    0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0xFF
};
...
static const char PROGMEM img_lock_caps[] = {
...
static bool render_status_slave(void) {
    ...
    switch (get_highest_layer(current_layer_state)) {
        case _QWERTY: oled_write_raw_P(img_lyr_base, sizeof(img_lyr_base)); break;
        case _LOWER:  oled_write_raw_P(img_lyr_lower, sizeof(img_lyr_lower)); break;
        case _RAISE:  oled_write_raw_P(img_lyr_raise, sizeof(img_lyr_raise)); break;
    ...
    oled_set_cursor(0, 4);
    oled_write_raw_P((current_mods & MOD_MASK_SHIFT) ? img_mod_shift : img_empty, sizeof(img_empty));
    oled_set_cursor(0, 5);
    oled_write_raw_P((current_mods & MOD_MASK_CTRL) ? img_mod_ctrl : img_empty, sizeof(img_empty));
    oled_set_cursor(0, 6);
    oled_write_raw_P((current_mods & MOD_MASK_ALT) ? img_mod_alt : img_empty, sizeof(img_empty));
    oled_set_cursor(0, 7);
    oled_write_raw_P((current_mods & MOD_MASK_GUI) ? img_mod_gui : img_empty, sizeof(img_empty));

    oled_set_cursor(0, 9);
    oled_write_raw_P(img_hdr_locks, sizeof(img_hdr_locks));
    oled_set_cursor(0, 10);
    oled_write_raw_P(current_caps ? img_lock_caps : img_empty, sizeof(img_empty));
